package org.wso2.custom.governance.registry.executor;
 ...
 */
public class ApiStoreExecutorApiRxt implements Execution {

    Log log = LogFactory.getLog(ApiStoreExecutorApiRxt.class);
    ...
    public boolean execute(RequestContext context, String currentState, String targetState) {
        ...
        try {
            ...
            GenericArtifactManager manager =  new GenericArtifactManager(RegistryCoreServiceComponent.
                    getRegistryService().getGovernanceUserRegistry(user,CarbonContext.getThreadLocalCarbonContext().getTenantId()), "api");
